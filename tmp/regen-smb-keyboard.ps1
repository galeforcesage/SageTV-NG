...
# Field selector row
L ($P1 + '<Panel Name="FieldRow" Sym="BASE-47324-FIELD-ROW">')
L ($P2 +  '<Text Name="Editing:" Sym="BASE-47324-FIELD-LABEL"/>')
L ($P2 +  '<Item Name="Field" Sym="BASE-47324-FIELD-BTN">')
L ($P3 +   '<FixedWidth>0.30</FixedWidth>')
L ($P3 +   '<Action Name="SMBAuthField = (SMBAuthField + 1) % 3" Sym="BASE-47324-FIELD-CYCLE">')
L ($P4 +    '<Action Name="Refresh()" Sym="BASE-47324-FIELD-REFRESH"/>')
L ($P3 +   '</Action>')
L ($P3 +   '<Conditional Name="SMBAuthField == 0" Sym="BASE-47324-FIELD-DISP-USER">')
L ($P4 +    '<Branch Name="true" Sym="BASE-47324-FIELD-DISP-USER-T"><Text Name="Username" Sym="BASE-47324-FIELD-USER-TEXT"/></Branch>')
L ($P3 +   '</Conditional>')
L ($P3 +   '<Conditional Name="SMBAuthField == 1" Sym="BASE-47324-FIELD-DISP-PASS">')
L ($P4 +    '<Branch Name="true" Sym="BASE-47324-FIELD-DISP-PASS-T"><Text Name="Password" Sym="BASE-47324-FIELD-PASS-TEXT"/></Branch>')
L ($P3 +   '</Conditional>')
L ($P3 +   '<Conditional Name="SMBAuthField == 2" Sym="BASE-47324-FIELD-DISP-DOM">')
L ($P4 +    '<Branch Name="true" Sym="BASE-47324-FIELD-DISP-DOM-T"><Text Name="Domain" Sym="BASE-47324-FIELD-DOM-TEXT"/></Branch>')
L ($P3 +   '</Conditional>')
...
L ($P2 +  '<IgnoreThemeProps>true</IgnoreThemeProps>')
L ($P2 +  '<BackgroundComponent>false</BackgroundComponent>')
# Tab - cycles SMBAuthField (glyph U+21B9 "leftwards arrow to bar over rightwards arrow to bar")
L ($P2 + '<Item Name="&#x21B9; Tab" Sym="BASE-47324-KEY-TAB">')
L ($P3 +  '<FixedWidth>0.20</FixedWidth>')
L ($P3 +  '<Action Name="SMBAuthField = (SMBAuthField + 1) % 3" Sym="BASE-47324-KEY-TAB-CYCLE">')
L ($P4 +   '<Action Name="Refresh()" Sym="BASE-47324-KEY-TAB-REFRESH"/>')
L ($P3 +  '</Action>')
L ($P2 + '</Item>')
...
L ($P4 +   '<Action Name="CurrentDirPath = SMBAuthHost" Sym="BASE-47324-KEY-ENTER-NAV">')
L ($P5 +    '<Action Name="SortedDirFiles = null" Sym="BASE-47324-KEY-ENTER-CLEAR">')
L ($P6 +     '<Action Name="CloseOptionsMenu()" Sym="BASE-47324-KEY-ENTER-CLOSE"/>')
L ($P5 +    '</Action>')
L ($P4 +   '</Action>')
L ($P3 +  '</Action>')
L ($P2 + '</Item>')

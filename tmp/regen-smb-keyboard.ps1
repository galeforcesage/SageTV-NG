...
L ($P3 +  '<FixedWidth>0.30</FixedWidth>')
L ($P3 +  '<Action Name="SMBAuthUserPart = If(Size(SMBAuthDomain) &gt; 0, SMBAuthDomain + &quot;;&quot; + SMBAuthUsername, SMBAuthUsername)" Sym="BASE-47324-KEY-ENTER-USERPART">')
L ($P4 +   '<Action Name="SMBAuthHostPath = Substring(java_lang_Object_toString(SMBAuthHost), 6, -1)" Sym="BASE-47324-KEY-ENTER-HOSTPATH">')
L ($P5 +    '<Action Name="SMBAuthHostKey = java_lang_Object_toString(SMBAuthHost)" Sym="BASE-47324-KEY-ENTER-HOSTKEY">')
L ($P6 +     '<Action Name="PrevSubgroup = GetSubgroup(NetworkPathPwdCache, SMBAuthHostKey)" Sym="BASE-47324-KEY-ENTER-LOOKUP">')
L ($P7 +      '<Conditional Name="PrevSubgroup != null" Sym="BASE-47324-KEY-ENTER-DROP-COND">')
L ($P7 +       '<Action Name="java_util_Map_remove(NetworkPathPwdCache, SMBAuthHostKey)" Sym="BASE-47324-KEY-ENTER-DROP"/>')
L ($P7 +      '</Conditional>')
L ($P7 +      '<Action Name="AddToGrouping(NetworkPathPwdCache, SMBAuthHostKey, DataUnion(SMBAuthUserPart, SMBAuthPassword))" Sym="BASE-47324-KEY-ENTER-CACHE">')
L ($P7 +       '<Action Name="CurrentDirPath = new_jcifs_smb_SmbFile(&quot;smb://&quot; + SMBAuthUserPart + &quot;:&quot; + SMBAuthPassword + &quot;@&quot; + SMBAuthHostPath)" Sym="BASE-47324-KEY-ENTER-NAV">')
L ($P7 +        '<Action Ref="53218" Name="IsValidDirBrowserDir = true"/>')
L ($P7 +        '<Action Name="SortedDirFiles = null" Sym="BASE-47324-KEY-ENTER-CLEAR">')
L ($P7 +         '<Action Name="Refresh()" Sym="BASE-47324-KEY-ENTER-REFRESH">')
